...
//task for copy a file of magento module
gulp.task('magento_copy', function() {
   gulp.src('./helpers/checkout_cart.js')
   .pipe(gulp.dest( __dirname +'/node_modules/magento/src/resources/'));
});
