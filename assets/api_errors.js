...
module.exports = {
  ...
  get_remove_customer: {
    error_code: "ERROR_WHILE_REMOVE_CUSTOMER",
    description: "There is some error while removing customer from Magento server via api"
  },

  duplicate_order: {
    error_code: "ERROR_WHILE_PLACING_DUPLICATE_ORDER",
    description: "There is some error while placing the duplicate order from Magento server via api"
  },
};
